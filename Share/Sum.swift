...
struct Sum: View {
    ...
    @FetchRequest(
        sortDescriptors: [NSSortDescriptor(keyPath: \Bili.timestamp, ascending: true)],
        animation: .default)
    private var items: FetchedResults<Bili>
...
//        }
    ...
    private func deleteItems(item: Bili) {
        withAnimation {
    ...
    private func updateItem(item: Bili) {
        withAnimation {
